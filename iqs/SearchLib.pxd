...
cdef extern from "src/SearchLib.h":
	...
	state_t *ctg(state_t *cur_sol, constraint_list_t *con, constraint_list_t *obj, int M, size_t *qtg_applications, int depth_look_ahead, int solver, int64_t stop_val, callback_t callback)
