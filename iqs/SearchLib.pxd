...
# 	# state_t *ctg(state_t *cur_sol, constraint_list_t *con, constraint_list_t *obj, int M, int *qtg_applications, int depth_look_ahead, int solver, char *store, long double stop_val)
#
...
# 	                                int allowed_false);
#
# 	long double ObjVal(state_t *state, constraint_list_t *obj);
#
