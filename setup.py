...
extensions = [
	...
	Extension("cbqs.state",
	          [
		          os.path.join("cbqs", "state.pyx"),
		          os.path.join("cbqs", "src", "solver.c"),
		          os.path.join("cbqs", "src", "SearchLib.c"),
		          os.path.join("cbqs", "src", "Branching.c"),
		          os.path.join("cbqs", "src", "intarray.c"),
	...
	Extension("cbqs.Constraint",
	          [
		          os.path.join("cbqs", "Constraint.pyx"),
		          os.path.join("cbqs", "src", "solver.c"),
		          os.path.join("cbqs", "src", "SearchLib.c"),
		          os.path.join("cbqs", "src", "Branching.c"),
		          os.path.join("cbqs", "src", "intarray.c"),
...
Extension("cbqs.branching",
	          [
		          os.path.join("cbqs", "branching.pyx"),
		          os.path.join("cbqs", "src", "solver.c"),
		          os.path.join("cbqs", "src", "SearchLib.c"),
		          os.path.join("cbqs", "src", "Branching.c"),
		          os.path.join("cbqs", "src", "intarray.c"),
