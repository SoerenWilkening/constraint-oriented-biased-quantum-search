...
- [x] **THRD-03**: Replace global `rand()` with per-thread PRNG (e.g., `rand_r()` or xoshiro256**)
- [x] **THRD-04**: Make thread count configurable — remove hardcoded `NUMThreads=6`, derive from model or user parameter
